 ...
 *
 */
public class LoadingScreen extends UIScreen implements Renderer {
	...
	public void wasAdded () {
		...
		ImageCache.getInstance().addImage("background", "images/background.png", assetWatcher);
		ImageCache.getInstance().addImage("circle", "images/circle.png", assetWatcher);
		assetWatcher.start();
    }
	
	public void start() {
		director.replace(new MainScreen());
	}
